          ...
          <div class="detail-section">
            ...
            <el-descriptions :column="2" border > 
              ...
              <el-descriptions-item label="主要情绪">
                <el-tag :type="getEmotionTagType(currentDetail.domainEmotion)">
                  {{ currentDetail.domainEmotion ||'-'}}
                </el-tag>
              </el-descriptions-item>
          ...
          <div class="detail-section">
            ...
            <el-descriptions :column="2" border >
              ...
              <el-descriptions-item label="情绪强度">
                <el-progress :percentage="aiData.emotionScore||0" :color="getEmotionScoreColor(aiData.emotionScore||0)" :stroke-width="8"/>
              </el-descriptions-item>
