     ...
     <div class="content">
        <div class="diary-card">
            ...
            <div class="section">
                ...
                <div class="rate">
                    <el-rate v-model="diaryForm.moodScore" :text="emotionStatus" show-texts :max="10" size="large"></el-rate>
                </div>
            </div>
        </div>
        <div class="diary-card">
         ...
         <div class="diary-card">
            ...
            <div class="detail-form">
                <div class="form-group">
                    ...
                    <el-input v-model="diaryForm.emotionTriggers"  type="textarea" :rows="3" maxLength="1000" show-word-limit placeholder="今天什么事情影响了您的情绪"> </el-input>
                
            </div>
            <div class="form-group">
                    <div class="form-label">今日感想</div>
                    <el-input v-model="diaryForm.diaryContent"   type="textarea" :rows="5" maxLength="2000" show-word-limit placeholder="写下您今天的想法、感受或发生的有趣事情..."> </el-input>
                </div>
                <!-- 生活指标 -->
...
const emotionStatus = 
['绝望崩溃', '消沉抑郁', '焦虑烦躁', '低落不悦', '平静淡然', '轻松惬意', '愉悦舒心', '欢欣满足', '兴奋欣喜', '极致幸福']
